...
use lib qw(/home/tickerlick/cgi-bin/version2);
use LWP::Simple;
...
my (%rephash);
our (%etfhash);
tie %etfhash, "DB_File", "/home/tickerlick/cgi-bin/version2/etfsecs" or die "Cannot open file 'etfsecs': $!\n";
...
my %tickerhash = &getResults('EMEY');
#my %tickerhash = &getResults('YHOO');
